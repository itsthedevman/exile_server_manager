...
class Bot
  ...
  def self.accept_request(id)
    ESM::IpcClient.call(:requests_accept, id: id).value
  end
  ...
  def self.decline_request(id)
    ESM::IpcClient.call(:requests_decline, id: id).value
  end
  ...
  def self.channel(channel_id, **filters)
    ESM::IpcClient.call(:channel, **filters.merge(id: channel_id)).value
  end
  ...
  def self.community_channels(community_id, user_id: nil)
    ESM::IpcClient.call(:community_channels, id: community_id, user_id: user_id).value || []
  end
  ...
  def self.community_modifiable_by?(community_id, user_id)
    ESM::IpcClient.call(:community_modifiable_by, id: community_id, user_id: user_id).value || false
  end
  ...
  def self.community_roles(community_id)
    ESM::IpcClient.call(:community_roles, id: community_id).value || []
  end
  ...
  def self.community_users(community_id)
    ESM::IpcClient.call(:community_users, id: community_id).value || []
  end
  ...
  def self.delete_community(community_id, user_id)
    ESM::IpcClient.call(:community_delete, id: community_id, user_id: user_id).value || false
  end
  ...
  def self.reconnect_server(id, old_id)
    ESM::IpcClient.call(:servers_reconnect, id: id, old_id: old_id).value
  end
  ...
  def self.send_message(channel_id:, message:)
    ESM::IpcClient.call(:channel_send, id: channel_id, message: message).value
  end
  ...
  def self.update_server(id)
    ESM::IpcClient.call(:servers_update, id: id).value
  end
  ...
  def self.user_community_permissions(user_id, guild_ids)
    ESM::IpcClient.call(:user_community_permissions, id: user_id, guild_ids: guild_ids).value || []
  end
  ...
  def self.server_connected?(server_id)
    ESM::IpcClient.call(:servers_connected, id: server_id).value
  end
end
