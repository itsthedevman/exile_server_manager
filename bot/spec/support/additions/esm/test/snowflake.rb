...
module ESM
  class Test
    ...
    #
    # Real Discord snowflakes are 17-20 digit timestamps. We reserve a base above any plausible real value
    # so a fake ID is recognisable at a glance in logs and assertions
    #
    module Snowflake
