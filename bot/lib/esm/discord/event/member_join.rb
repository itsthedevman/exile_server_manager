        ...
        def send_esm_welcome_message
          embed =
            ESM::Embed.build do |e|
              e.set_author(name: ESM.discord_bot.profile.username, url: "https://www.esmbot.com", icon_url: ESM.discord_bot.profile.avatar_url)
          ...
          ESM.discord_bot.deliver(embed, to: @user)
        end
