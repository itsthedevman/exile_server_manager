  ...
  module Arma
    class Client
      ...
      def close(reason = "")
        ...
        ESM::Arma::Server.on_disconnect(self)
      ...
      # @param type [Symbol] The type of request. See ESM::Arma::Request::TYPES
      ...
      #
      # @return [ESM::Arma::Promise, ESM::Message]
      ...
      #     See ESM::Arma::Client::Request::TYPES for full list
      ...
      #
      # @return [ESM::Arma::Client::Promise]
      #
